...
function TextSelectorBar({ puncChangeFunc, numChangeFunc, capsChangeFunc, puncState, numState, capsState, divColour, textColour, hoverColour, textSelectColour }: SelectorProp) {
  ...
  const capsTextColour = `${capsState ? textSelectColour : textColour}`;

  const puncSvgColour = `${puncState ? fillSelectColour : fillColour}`;
  const numSvgColour = `${numState ? fillSelectColour : fillColour}`;
  const capsSvgColour = `${capsState ? fillSelectColour : fillColour}`;
  ...
  return (
    <div className={modifiedOuterDivClass}>
      ...
      <div className={modifiedInnerDivClass + numTextColour} onClick={numChangeFunc}>
      ...
      <div className={modifiedInnerDivClass + capsTextColour} onClick={capsChangeFunc}>
