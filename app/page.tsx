  ...
  return (
    <div className="flex flex-row items-center justify-end w-screen h-screen gap-28 bg-dolphin-bg">
      <div className="flex flex-col items-center justify-start gap-28 translate-y-20"> 
        <TypingArea textColour="text-dolphin-dull" textColourCorrect="text-dolphin-bright" textColourIncorrect="text-dolphin-wrong" selectorDivColour="bg-dolphin-navbar" selectorTextColour="text-dolphin-dull" selectorSelectedColour="text-dolphin-wrong" selectorHoverColour="text-dolphin-bright"/>
