...
function TextSelectorBar({
	...
	const numDivColour = `${numState ? textSelectColour : textColour} ${
		numState ? borderSelectColour : borderColour
	}`;
	const capsDivColour = `${capsState ? textSelectColour : textColour} ${
		capsState ? borderSelectColour : borderColour
	}`;
	...
	return (
		...
		>
			...
			<div
				className={
					modifiedInnerDivClass +
					capsDivColour +
					(isTypingTest ? "" : lastClass)
				}
